...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailoverPeer) DeepCopyInto(out *FailoverPeer) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailoverPeer.
func (in *FailoverPeer) DeepCopy() *FailoverPeer {
	if in == nil {
		return nil
	}
	out := new(FailoverPeer)
	in.DeepCopyInto(out)
	return out
}
