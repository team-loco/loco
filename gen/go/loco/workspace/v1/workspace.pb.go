...
func (x *WorkspaceMember) GetScopes() []string {
	if x != nil {
		return x.Scopes
	}
	return nil
...
func (x *WorkspaceMemberWithUser) GetScopes() []string {
	if x != nil {
		return x.Scopes
	}
	return nil
...
func (x *CreateMemberRequest) GetScopes() []string {
	if x != nil {
		return x.Scopes
	}
	return nil
...
const file_loco_workspace_v1_workspace_proto_rawDesc = "" +
	...
	"\x17DeleteWorkspaceResponse\"\xf4\x01\n" +
	"\x13CreateMemberRequest\x12+\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\vworkspaceId\x12!\n" +
	"\auser_id\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x06userId\x12\x8c\x01\n" +
	"\x06scopes\x18\x03 \x03(\tBt\xbaHq\x92\x01n\b\x01\"j\xba\x01g\n" +
	"\x12scope.valid_values\x12-each scope must be one of: read, write, admin\x1a\"this in ['read', 'write', 'admin']R\x06scopes\"R\n" +
	...
	"\x14ListWorkspaceMembers\x12..loco.workspace.v1.ListWorkspaceMembersRequest\x1a/.loco.workspace.v1.ListWorkspaceMembersResponseB@Z>github.com/team-loco/loco/gen/go/loco/workspace/v1;workspacev1b\x06proto3"
