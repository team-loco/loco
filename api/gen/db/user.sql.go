...
func (q *Queries) CheckUserHasOrganizations(ctx context.Context, createdBy pgtype.UUID) (bool, error) {
...
func (q *Queries) CheckUserHasWorkspaces(ctx context.Context, userID pgtype.UUID) (bool, error) {
