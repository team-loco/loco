...
// 	protoc        (unknown)
// source: loco/registry/v1/registry.proto
...
const file_loco_registry_v1_registry_proto_rawDesc = "" +
	...
	"\x0eGetGitlabToken\x12'.loco.registry.v1.GetGitlabTokenRequest\x1a(.loco.registry.v1.GetGitlabTokenResponse\"\x00BDZBgithub.com/team-loco/loco/shared/proto/loco/registry/v1;registryv1b\x06proto3"

var (
	file_loco_registry_v1_registry_proto_rawDescOnce sync.Once
	file_loco_registry_v1_registry_proto_rawDescData []byte
)

func file_loco_registry_v1_registry_proto_rawDescGZIP() []byte {
	file_loco_registry_v1_registry_proto_rawDescOnce.Do(func() {
		file_loco_registry_v1_registry_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loco_registry_v1_registry_proto_rawDesc), len(file_loco_registry_v1_registry_proto_rawDesc)))
	})
...
func init() { file_loco_registry_v1_registry_proto_init() }
func file_loco_registry_v1_registry_proto_init() {
	if File_loco_registry_v1_registry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_loco_registry_v1_registry_proto_goTypes,
		DependencyIndexes: file_loco_registry_v1_registry_proto_depIdxs,
		MessageInfos:      file_loco_registry_v1_registry_proto_msgTypes,
	}.Build()
	File_loco_registry_v1_registry_proto = out.File
	file_loco_registry_v1_registry_proto_goTypes = nil
	file_loco_registry_v1_registry_proto_depIdxs = nil
}
