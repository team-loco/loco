...
// 	protoc        (unknown)
// source: loco/user/v1/user.proto
...
func (x *User) Reset() {
	*x = User{}
	mi := &file_loco_user_v1_user_proto_msgTypes[0]
...
const file_loco_user_v1_user_proto_rawDesc = "" +
	...
	"\x06Logout\x12\x1b.loco.user.v1.LogoutRequest\x1a\x1c.loco.user.v1.LogoutResponseB<Z:github.com/team-loco/loco/shared/proto/loco/user/v1;userv1b\x06proto3"

var (
	file_loco_user_v1_user_proto_rawDescOnce sync.Once
	file_loco_user_v1_user_proto_rawDescData []byte
)

func file_loco_user_v1_user_proto_rawDescGZIP() []byte {
	file_loco_user_v1_user_proto_rawDescOnce.Do(func() {
		file_loco_user_v1_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loco_user_v1_user_proto_rawDesc), len(file_loco_user_v1_user_proto_rawDesc)))
	})
...
func init() { file_loco_user_v1_user_proto_init() }
func file_loco_user_v1_user_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_loco_user_v1_user_proto_goTypes,
		DependencyIndexes: file_loco_user_v1_user_proto_depIdxs,
		MessageInfos:      file_loco_user_v1_user_proto_msgTypes,
	}.Build()
	File_loco_user_v1_user_proto = out.File
	file_loco_user_v1_user_proto_goTypes = nil
	file_loco_user_v1_user_proto_depIdxs = nil
}
